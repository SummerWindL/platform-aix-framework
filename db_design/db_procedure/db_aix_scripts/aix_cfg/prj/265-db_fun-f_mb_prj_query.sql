CREATE OR REPLACE FUNCTION f_mb_prj_query(
...
begin
	...
	(
		...
		from t_mb_prj a
	     where 
	     		(in_projectid = '' or a.projectid = in_projectid) and 
	     		(in_projectname = '' or a.projectname = in_projectname) AND 
	     		(in_hospcode = '' OR a.hospcode = in_hospcode)
